(module
  (import "module_2" "double" (func $double (param i32) (result i32)))
  (import "module_2" "log" (func $log (param i32 i32)))
  (import "module_2" "memory" (memory 1))
  (import "module_2" "memory_offset" (global $offset i32))
